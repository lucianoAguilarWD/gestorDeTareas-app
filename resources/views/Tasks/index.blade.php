...
@section('content')
    <main>
        ...
        <section id="task-filters">
            ...
            <form action="{{ route('tasks.index') }}" method="GET" id="filter-form">
                ...
                <div class="form-group">
                    <!-- Filtro de usuario -->
                    <div>
                        <input type="checkbox" name="mis_tareas" value="1" class="form-checkbox text-blue-500"
                            {{ request('mis_tareas') ? 'checked' : '' }} onchange="this.form.submit()">
        ...
        <section id="task-list">
            ...
            <div>
                <a href="{{ route('viewCrearTarea') }}"
                    style="background-color: rgb(3, 148, 148); color: white; padding: 5px; border-radius: 4px"> Crear Nueva
                    Tarea </a>
            </div>
                    ...
                    <ul class="task-card-grid">
                        <li class="task-card">
                            ...
                            <div class="task-card-actions">
                                <a href="{{ route('edit_tarea', $task->id) }}"><button type="button"
                                        class="edit-btn btn">Editar</button></a>
